...
def extract_on_paths(file_paths, shape_predictor_path):
...
def parse_args():
    ...
    parser.add_argument("--num_threads", type=int, default=12, help='Number of CPU threads to execute alignment')
    parser.add_argument("--raw_dir", type=str, default='', help='Raw input images for transformation')
    parser.add_argument("--saved_dir", type=str, default='', help='Save path for aligned input images for transformation')
    parser.add_argument("--shape_predictor_path", type=str, default='', help='Face landmarks model (https://github.com/italojs/facial-landmarks-recognition/blob/master/shape_predictor_68_face_landmarks.dat)')
...
def run(args):
    ...
    if args.run_parallel:
        ...
        pool.map(extract_on_paths, file_chunks, args.shape_predictor_path)
    else:
        extract_on_paths(file_paths, args.shape_predictor_path)
    print('Done!')
